<div id="frituren">
	<div id="info">
		...
		<h6><?php echo htmlspecialchars_decode($f7); ?> </h6>
		<div id="text"><?php echo htmlspecialchars_decode($f1); ?></div><br><br>
		<b>Prijs</b> : <?php echo htmlspecialchars_decode($f3); ?> &euro;<br>
		<b>Huur</b> : <?php echo htmlspecialchars_decode($f4); ?> &euro;
